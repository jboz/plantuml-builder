...
public abstract class AbstractClassDiagramBuilder implements LinkMaker {
    ...
    public <B extends AbstractClassDiagramBuilder> B setAfterStartTags(String... afterStartTags) {
        this.afterStartTags = afterStartTags;
        return (B) this;
    }
